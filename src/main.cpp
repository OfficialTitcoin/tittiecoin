...
// Copyright (c) 2011-2015 TittieCoin Developers.
...
uint256 hashGenesisBlock("0x3266039e47d48d6798664f8d7f6cbfe596e4ebbdb2e524e7c5f07cb6b49374bd");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20);
static CBigNum bnInitialDifficulty(~uint256(0) >> 28);
...
const string strMessageMagic = "TittieCoin Signed Message:\n";
...
static const int64 nTargetTimespan =  10 * 3 * 60;
static const int64 nTargetSpacing = 3 * 60; //Tittiecoin: 3 minutes between blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // TittieCoin: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    int64 nActualTimespanMax = ((nTargetTimespan*80)/60);
    int64 nActualTimespanMin = ((nTargetTimespan*60)/80);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal TittieCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TittieCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x43b4cdf03c86099a0755f1c018d1a13bf05afab43bc92a93b42bc88a70fef31");
    }
...
// Genesis block
        const char* pszTimestamp = "TittyCoin - Come Grab It!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04a5814313115273a108cff99907ba4a05d951873dae7acb6c973d0c9e7c88911a3dbc9aa600deac241b91707e7b4ffb30ad91c8e56e695a1ddf318592988afe0a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1390788346;
		...
		assert(block.hashMerkleRoot == uint256("0x4642853cdcef7509f3094924f15dbf926d2efb76a2276e2d7c8cc15a481f4843"));
...
unsigned char pchMessageStart[4] = { 0xd9, 0xfa, 0xac, 0xb3 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // TittieCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
