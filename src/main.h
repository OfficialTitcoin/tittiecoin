...
static const int64 MAX_MONEY = 5612006400 * COIN; // 
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // TittieCoin: 480 blocks found a day. Priority cutoff is 1 TittieCoin day / 250 bytes.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("04a68259132152732109cff99907ba4a042951873dae7acb6c973d0c9e7c88911a3dbc9aa600deac241b91707e7b4fcb30ad91c8e56e695a1ddf318592988afe0a")))
